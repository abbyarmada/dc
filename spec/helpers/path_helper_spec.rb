...
describe DC::PathHelper, 'meta singular path helper' do
  before(:each) do
...
describe DC::PathHelper, 'meta plular path helper' do
  before(:each) do
    params[:component] = 'links'
    @entry = FactoryGirl.create(:link)
  end
  after(:each) do
    params[:component] = nil
    @entry = nil
